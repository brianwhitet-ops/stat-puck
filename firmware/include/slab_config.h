...
#define SLAB_PERSIST_VERSION 2
#define SLAB_SCHEMA_VERSION 2
#define SLAB_ROUND_ID_SIZE 65
#define SLAB_DEVICE_ID_SIZE 49
#define SLAB_PAYLOAD_SIZE 4096
#define SLAB_QUEUE_CAPACITY 10
